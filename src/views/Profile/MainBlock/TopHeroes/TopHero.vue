  ...
  <div class="hero-portrait-wrapper mb-5 mb-sm-0">
    ...
    <div class="p-2 bg-dark">
      <h5 class="text-truncate m-0 text-center title-name font-diablo" :class="{'bg-danger' : hero.hardcore}">
        {{ hero.name }}
        <img v-if="hero.seasonal"
             src="https://raw.githubusercontent.com/baumannzone/diablo3-vue-platzi/master/src/assets/img/leaf.png"
             width="12px"
             class=""
        />
      </h5>
...
export default {
  ...
  computed: {
    heroClass () {
      const gender = !this.hero.gender ? 'male' : 'female';
