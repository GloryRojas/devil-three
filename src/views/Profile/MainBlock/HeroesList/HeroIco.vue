<template>
  <div class="hero-ico d-flex align-items-center">
    ...
    <img v-if="hero.seasonal" src="https://raw.githubusercontent.com/baumannzone/diablo3-vue-platzi/master/src/assets/img/leaf.png" width="12px" class="ml-2" alt="seasonal_leaf" />
  </div>
</template>
<script>
export default {
